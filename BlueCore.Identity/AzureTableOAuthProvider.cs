...
{
    /// <summary>
    /// Azure table storage provider to support external login services via the OAuth standard.
    /// </summary>
    /// <typeparam name="T">The type of user being authorized.</typeparam>
    public class AzureTableOAuthProvider<T> : OAuthAuthorizationServerProvider where T : AzureTableUser
    {
        private readonly string _publicClientId;
        private readonly Func<UserManager<T>> _userManagerFactory;

        public AzureTableOAuthProvider(string publicClientId, Func<UserManager<T>> userManagerFactory)
        {
